 ...
 *SDL_HINT_WINRT_PRIVACY_POLICY_URL
 *  will not get used on that platform.  Network-enabled phone apps should
 *display
 ...
 *8.1, and RT,
 *  Microsoft mandates that this policy be available via the Windows Settings
 *charm.
 *  SDL provides code to add a link there, with it's label text being set via
 *the
 *  optional hint, SDL_HINT_WINRT_PRIVACY_POLICY_LABEL.
 *
 *  Please note that a privacy policy's contents are not set via this hint.  A
 *separate
 *  hint, SDL_HINT_WINRT_PRIVACY_POLICY_URL, is used to link to the actual text
 *of the
 *  policy.
 *
...
/** \brief If set to 1, back button press events on Windows Phone 8+ will be
 *marked as handled.
 *
