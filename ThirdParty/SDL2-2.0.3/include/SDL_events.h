...
typedef enum {
	...
	SDL_JOYDEVICEADDED,   /**< A new joystick has been inserted into the
				 system */
	...
	SDL_CONTROLLERDEVICEADDED, /**< A new Game controller has been inserted
				      into the system */
	SDL_CONTROLLERDEVICEREMOVED,  /**< An opened Game controller has been
					 removed */
...
typedef struct SDL_MouseWheelEvent {
	...
	Sint32 y; /**< The amount scrolled vertically, positive away from the
...
typedef struct SDL_JoyDeviceEvent {
	...
	Uint32 timestamp;
	Sint32 which; /**< The joystick device index for the ADDED event,
...
typedef struct SDL_ControllerButtonEvent {
	Uint32
	    type; /**< ::SDL_CONTROLLERBUTTONDOWN or ::SDL_CONTROLLERBUTTONUP */
	Uint32 timestamp;
	SDL_JoystickID which; /**< The joystick instance id */
...
typedef struct SDL_ControllerDeviceEvent {
	Uint32 type; /**< ::SDL_CONTROLLERDEVICEADDED,
